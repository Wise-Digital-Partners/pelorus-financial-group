        ...
        <div className="container">
          <div className="grid md:grid-cols-12 lg:justify-between space-y-10 lg:space-y-0 lg:space-x-8 mb-20 lg:mb-16">
            <div className="lg:col-start-1 md:col-span-4">
              ...
              <p className="text-white text-[12px] mb-10">Securities offered through The Leaders Group, Inc. Member <a href="http://www.finra.org/" target="_blank">FINRA</a> / <a href="http://www.sipc.org/" target="_blank">SIPC</a> 26 W. Dry Creek Circle, Suite 800, Littleton CA 80120 303-797-9080.  Pelorus Financial Group is not affiliated with The Leaders Group, Inc.</p>
              <Newsletter />
            </div>
