  ...
  return (
    <Layout>
      <SearchEngineOptimization
        title="Insurance Carriers | Pelorus Financial Group"
        description="Get the best products for your clients. At Pelorus, we work with leading, highly-rated carriers for life insurance, annuities, disability, and long-term care."
      ...
      <section className="pt-12 md:pt-16 mb-20 md:mb-32">
        <div className="container">
          <header className="max-w-4xl mx-auto mb-14 md:mb-18 text-center">
            <h1>Carriers</h1>
            <p>
              We partner with leading carriers for life insurance, annuities,
              disability, and long-term care. These carriers are highly rated,
              which means you can rest assured you’re getting the best products
              for your clients.
            </p>
            <ButtonGhost
              href="https://prodinfo.ipipeline.com/productlist?GAID=7205"
              outboundLink={true}
              text={[
                "Carrier Ratings & Links",
