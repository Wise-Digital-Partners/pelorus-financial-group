        ...
        <div className="container">
          ...
          <ol className="list-disc pl-6 mb-6">
            <li>
              ...
              materials (information or software) on Pelorus Insurance
              Services's web site for personal, non-commercial transitory
              ...
              <ol className="list-decimal pl-6 mb-6">
                ...
                <li>
                  ...
                  contained on Pelorus Insurance Services's web site;
                </li>
                <li>
            ...
            <li>
              ...
              these restrictions and may be terminated by Pelorus Insurance
              Services at any time. Upon terminating your viewing of these
          ...
          <ol className="list-disc pl-6 mb-6">
            <li>
              The materials on Pelorus Insurance Services's web site are
              provided "as is". Pelorus Insurance Services makes no warranties,
              expressed or implied, and hereby disclaims and negates all other
              warranties, including without limitation, implied warranties or
              conditions of merchantability, fitness for a particular purpose,
              or non-infringement of intellectual property or other violation of
              rights. Further, Pelorus Insurance Services does not warrant or
          ...
          <h3>4. Limitations</h3>
          <p>
            In no event shall Pelorus Insurance Services or its suppliers be
            ...
            out of the use or inability to use the materials on Pelorus
            Insurance Services's Internet site, even if Pelorus Insurance
            Services or a Pelorus Insurance Services authorized representative
          ...
          <p>
            The materials appearing on Pelorus Insurance Services's web site
            could include technical, typographical, or photographic errors.
            Pelorus Insurance Services does not warrant that any of the
            materials on its web site are accurate, complete, or current.
            Pelorus Insurance Services may make changes to the materials
            contained on its web site at any time without notice. Pelorus
            Insurance Services does not, however, make any commitment to update
            the materials.
          </p>
          <h3>6. Links</h3>
          <p>
            Pelorus Insurance Services has not reviewed all of the sites linked
            ...
            endorsement by Pelorus Insurance Services of the site. Use of any
            such linked web site is at the user's own risk.
          </p>
          <h3>7. Site Terms of Use Modifications</h3>
          <p>
            Pelorus Insurance Services may revise these terms of use for its web
          ...
          <p>
            Any claim relating to Pelorus Insurance Services's web site shall be
